        ...
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-4/5 md:px-20">
          <div className={styles.shape} />
           <p className={`text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            <strong>Welcome to ConvergIN-Bot Chatbot - Engage Smarter, Faster, and Better with ConvergIN-Bot.</strong>          
          </p>
          ...
          >
            <span>ConvergIN-Bot</span> <ArrowRightIcon className="w-5 md:w-6" />
          </Link>
        </div>
